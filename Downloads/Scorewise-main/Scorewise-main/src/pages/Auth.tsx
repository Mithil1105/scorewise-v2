...
import { Mail, Lock, Chrome, ArrowRight, User, MailCheck, Loader2 } from 'lucide-react';
import { z } from 'zod';
    ...
    try {
      ...
      if (error) {
        ...
        toast({
          ...
          description: `We've sent a new verification email to ${unverifiedEmail}. Please check your inbox.`,
        });
      }
    } catch (err) {
      toast({
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription className="pt-2">
                ...
                <br /><br />
                Please check your inbox and click the verification link we sent you. If you didn't receive the email, check your spam folder or click the button below to request a new verification email.
              </AlertDialogDescription>
            </AlertDialogHeader>
